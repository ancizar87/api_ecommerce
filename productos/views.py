...
from productos.models import Favoritos as FavoritosModel
...
class Favoritos(APIView):
    ...
    def post(self, request):
        ...
        ProductoModel, id=self.request.data.get('id', 0)
        )

        favorito, created = FavoritosModel.objects.get_or_create(
